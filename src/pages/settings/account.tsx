...
const Account: NextPage = () => {
  ...
  const accountOptions = [
    { title: "Nom", value: localName, setValue: setLocalName },
    { title: "Nom d'utilisateur", value: localUsername, setValue: setLocalUsername },
  ];
    ...
    <div>
      ...
      <div className="mx-auto flex flex-col gap-5 px-4 py-20 sm:py-10 md:pl-28 lg:pl-72">
        ...
        <div className="flex justify-center gap-12">
          ...
          <SettingsRightNav selectedTab="Compte" />
        </div>
      </div>
    </div>
  );
