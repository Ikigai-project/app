...
const goalXpOptions = [
  { title: "Basique", xp: 1 },
  { title: "Occasionnel", xp: 10 },
  { title: "Régulier", xp: 20 },
  { title: "Sérieux", xp: 30 },
  { title: "Intensif", xp: 50 },
] as const;
        ...
        <div className="flex justify-center gap-12">
          <div className="flex w-full max-w-xl flex-col gap-8">
            <p className="text-gray-400">
              Votre coach est là ! Sélectionner un objectif quotidien vous aidera à rester
              motivé pendant votre apprentissage d'IKIGAI. Vous pouvez modifier votre objectif
              à tout moment.
            </p>
                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        xp === localGoalXp
                          ? "border-b-2 border-[#41D185] bg-[#e6f9ee] text-[#2CA86E]"
          ...
          <SettingsRightNav selectedTab="Objectif quotidien" />
        </div>
      </div>
    </div>
  );
