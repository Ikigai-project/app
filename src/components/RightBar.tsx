...
export const RightBar = () => {
  ...
  return (
    <>
      <aside className="sticky top-[58px] hidden sm:flex md:flex lg:flex flex-col gap-4 self-start 
                        px-4 md:w-64 lg:w-80 transition-all duration-300 max-h-screen overflow-y-auto pb-6">
        <article className="my-4 flex flex-col sm:flex-row justify-between gap-3">
          <div
            className="relative flex cursor-default items-center gap-2 rounded-xl p-2 md:p-3 font-bold uppercase 
                      text-gray-500 hover:bg-gray-100 transition-all duration-300"
            ...
            tabIndex={0}
          >
            <h2 className="px-3 md:px-5 py-2 md:py-3 font-bold uppercase text-gray-400 text-sm md:text-base">
              Mes cours
            </h2>
            <button className="flex w-full items-center gap-3 border-t-2 border-gray-300 bg-blue-100 px-3 md:px-5 py-2 md:py-3 
                              text-left font-bold text-sm md:text-base rounded-t-lg">
              <span className="text-blue-500">{language?.name || 'Aucun cours sélectionné'}</span>
            </button>
            <Link
              className="flex w-full items-center gap-3 rounded-b-xl border-t border-gray-300 px-3 md:px-5 py-2 md:py-3 
                        text-left font-bold hover:bg-gray-100 text-sm md:text-base transition-all duration-300"
              href="/register"
            >
          ...
          <div className="flex md:flex-row gap-2 mt-2 sm:mt-0">
            <span
              className="relative flex items-center gap-2 rounded-xl p-2 md:p-3 font-bold text-orange-500 hover:bg-gray-100 
            ...
            >
              ...
              >
                ...
                <p className="text-center text-sm font-normal text-gray-400">
                  {`Votre série sera réinitialisée demain si vous ne pratiquez pas. Soyez vigilant !`}
                </p>
                <Calendar now={now} setNow={setNow} />
              </div>
            </span>
            <span
              className="relative flex items-center gap-2 rounded-xl p-2 md:p-3 font-bold text-red-500 hover:bg-gray-100 
                        transition-all duration-300"
            ...
            >
              ...
              <div
                className="absolute top-full z-10 flex w-60 sm:w-64 md:w-72 items-center gap-3 rounded-2xl border-2 
                          border-gray-300 bg-white p-5 shadow-lg transform transition-all duration-300"
                style={{
                  left: "calc(50% - 120px)",
                  display: gemsShown ? "flex" : "none",
                }}
              >
                <LingotsTreasureChestSvg className="w-16 md:w-24" />
                <div className="flex flex-col gap-3">
                  <h2 className="text-base md:text-lg font-bold text-black">Lingots</h2>
        ...
        {/* Sections conditionnelles avec animation */}
...
const UnlockLeaderboardsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-4 rounded-2xl border-2 border-gray-200 p-4 md:p-6 text-gray-700 bg-white shadow-sm hover:shadow-md transition-all duration-300">
      <h2 className="text-base md:text-lg font-bold">Débloquer les classements !</h2>
      <div className="flex items-center gap-4 md:gap-6">
        <LockedLeaderboardsSvg />
        <p className="text-xs md:text-sm leading-6 text-gray-500">
  ...
  return (
    <article className="flex flex-col gap-4 rounded-2xl border-2 border-gray-200 p-4 md:p-6 text-gray-700 bg-white shadow-sm hover:shadow-md transition-all duration-300">
      <div className="flex items-center justify-between">
        <h2 className="text-base md:text-lg font-bold">{leaderboardLeague}</h2>
        <Link href="/leaderboard" className="font-bold uppercase text-blue-400 text-xs md:text-sm">
          Voir la ligue
        </Link>
      </div>
      <div className="flex gap-4 md:gap-6">
        ...
        <div className="flex flex-col gap-3 md:gap-5">
          ...
          <p className="text-xs md:text-sm leading-6 text-gray-500">
            Vous avez gagné {xpThisWeek} XP cette semaine jusqu'à présent
          </p>
        </div>
      </div>
    </article>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center">
            <div className="relative h-4 md:h-5 w-36 sm:w-40 md:w-52 rounded-l-full bg-gray-200">
              ...
              >
                <div className="absolute left-2 right-0 top-1 h-1 md:h-2 rounded-l-full bg-yellow-300"></div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 top-0 flex items-center justify-center text-xs md:text-sm text-gray-400">
                {xpToday} / {goalXp}
              </div>
            </div>
            <TreasureProgressSvg className="w-6 h-6 md:w-auto md:h-auto" />
          </div>
        </div>
      </div>
    </article>
...
const LockedLeaderboardsSvg = () => {
  return (
    <svg width="40" height="46" viewBox="0 0 40 46" fill="none" className="w-8 h-8 md:w-10 md:h-10 lg:w-auto lg:h-auto">
      <path
...
const TreasureClosedSvg = (props: ComponentProps<"svg">) => {
  return (
    <svg width="76px" height="76px" viewBox="0 0 76 76" className="w-16 h-16 md:w-20 md:h-20 lg:w-auto lg:h-auto" {...props}>
      <defs>
        <path
        ...
        />
        <path
          d="M2.74830565,5.45096283 C1.23046041,5.45096283 0,4.2307212 0,2.72548142 C0,1.22024164 1.23046041,0 2.74830565,0 C4.26615308,0 5.49661129,1.22024164 5.49661129,2.72548142 C5.49661129,4.2307212 4.26615308,5.45096283 2.74830565,5.45096283 Z"
          id="path-29"
        />
        <path
          d="M2.74830565,5.45096283 C1.23045821,5.45096283 0,4.2307212 0,2.72548142 C0,1.22024164 1.23045821,0 2.74830565,0 C4.26615308,0 5.49661129,1.22024164 5.49661129,2.72548142 C5.49661129,4.2307212 4.26615308,5.45096283 2.74830565,5.45096283 Z"
...
const XpProgressSection = () => {
  ...
  return (
    <article className="flex flex-col gap-4 rounded-2xl border-2 border-gray-200 p-4 md:p-6 font-bold text-gray-700 bg-white shadow-sm hover:shadow-md transition-all duration-300">
      <div className="flex items-center justify-between">
        <h2 className="text-base md:text-lg">Progression XP</h2>
        <Link href="/settings/coach" className="uppercase text-blue-400 text-xs md:text-sm">
          Modifier l'objectif
        </Link>
      </div>
      <div className="flex gap-3 md:gap-5">
        ...
        <div className="flex grow flex-col justify-around">
          <h3 className="font-normal text-gray-500 text-sm md:text-base">Objectif quotidien</h3>
          <div className="flex items-center gap-3 md:gap-5">
            <div className="relative h-3 md:h-4 w-full grow rounded-full bg-gray-200">
              {xpToday > 0 && (
                <div
                  className="absolute left-0 top-0 h-3 md:h-4 rounded-full bg-yellow-400 transition-all duration-300"
                  style={{ width: `${Math.min(1, xpToday / goalXp) * 100}%` }}
                >
                  <div className="absolute left-2 right-2 top-1 h-1 md:h-[6px] rounded-full bg-yellow-300"></div>
                </div>
              )}
            </div>
            <div className="text-sm md:text-md shrink-0 font-normal text-gray-400">
              {xpToday}/{goalXp} XP
            </div>
          </div>
        </div>
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-4 rounded-2xl border-2 border-gray-200 p-4 md:p-6 font-bold bg-white shadow-sm hover:shadow-md transition-all duration-300">
      <h2 className="text-base md:text-lg">Créez un profil pour sauvegarder votre progression !</h2>
      <button
        className="rounded-2xl border-b-4 border-green-600 bg-green-500 py-2 md:py-3 uppercase text-white transition hover:border-green-500 hover:bg-green-400 text-sm md:text-base"
        onClick={() => setLoginScreenState("SIGNUP")}
      >
        Créer un profil
      </button>
      <button
        className="rounded-2xl border-b-4 border-blue-500 bg-blue-400 py-2 md:py-3 uppercase text-white transition hover:border-blue-400 hover:bg-blue-300 text-sm md:text-base"
