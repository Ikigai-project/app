...
export const RightBar = () => {
  ...
  return (
    <>
      <aside className="sticky top-0 hidden w-80 flex-col gap-4 self-start sm:flex">
        <article className="my-4 flex justify-between gap-3">
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <h2 className="text-lg font-bold text-black">Lingots</h2>
...
const UnlockLeaderboardsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      <h2 className="text-lg font-bold">Débloquer les classements !</h2>
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold">{leaderboardLeague}</h2>
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <h2 className="text-lg">Quêtes quotidiennes</h2>
      <div className="flex items-center gap-4">
        <LightningProgressSvg />
        <div className="flex flex-col gap-2">
          <h3>Gagnez {goalXp} XP</h3>
...
const XpProgressSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <div className="flex items-center justify-between">
        <h2 className="text-lg">Progression XP</h2>
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold">
      <h2 className="text-lg">Créez un profil pour sauvegarder votre progression !</h2>
      <button
